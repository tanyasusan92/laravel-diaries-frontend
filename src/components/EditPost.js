...
function EditPost() {
    ...
    axios        
        .post(`http://localhost:8000/api/posts/${id}/edit`, 
        post,        
    ...
    return(<div className="bg-login-blue flex flex-wrap justify-center items-center py-20">
    <div className="max-w-sm lg:max-w-lg flex flex-auto m-2">        
        ...
        <form onSubmit={handleSubmit}>
            ...
            {/* <!-- Content input --> */}
            <div className="mb-6">
              <textarea className="form-control block w-full px-4 py-2 text-xl 
